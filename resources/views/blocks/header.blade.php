        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto text-center">
             ...
             <div class="d-flex mx-auto" style="width: 40%">
                 <form class="form-inline md-form form-sm active-cyan-2 my-1 mx-auto">
                     <input class="form-control form-control-sm mr-3 w-75" type="text" placeholder="Search"
                            aria-label="Search">
                     <i class="fas fa-search text-white ml-3 active" aria-hidden="true" style="color: #fff !important">

                     </i>
                 </form>
                 <!-- Right Side Of Navbar -->
                 <ul class="navbar-nav ml-5">
                     <li class="nav-item text-center pt-4 pb-5 px-3" style="background: linear-gradient(180deg, #FD595A 0%, #8C1314 100%);">
                         <a href="" class="" style="position:absolute;padding-top: 38px;padding-left: 4px;"><img src="{{asset('img/0.png')}}" alt="" class="img-fluid"></a>
