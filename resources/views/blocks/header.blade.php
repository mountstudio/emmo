<nav class="col-12 navbar navbar-expand-lg navbar-light shadow-none pt-0">
           ...
           <div class="col-12 col-md-2 pl-0">
               ...
               <ul class="navbar-nav ml-5 col-12 col-md-5">
                   <li class="nav-item text-center pt-4 pb-5 px-3"
                       ...
                       <a href="{{ route('cart.checkout') }}" class="cart cart-count" style="position:absolute;padding-top: 38px;padding-left: 4px;">
                           <img src="{{asset('img/0.png')}}" alt="" class="img-fluid"></a>
